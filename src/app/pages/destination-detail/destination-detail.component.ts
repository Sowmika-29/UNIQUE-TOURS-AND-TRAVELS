      ...
      <div class="relative h-[50vh] min-h-[400px] w-full bg-slate-900 overflow-hidden">
        ...
        <div class="absolute bottom-0 left-0 w-full p-8 md:p-16 z-20">
          <div class="max-w-7xl mx-auto">
            ...
            <h1 class="text-5xl md:text-7xl font-bold text-white drop-shadow-2xl tracking-tight animate-heading">{{destination.name}}</h1>
          </div>
        </div>
      </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div class="lg:col-span-2">
            ...
            <!-- PLACES -->
            <div class="mb-16">
               <h2 class="text-3xl font-bold text-slate-800 mb-8 border-b-4 border-sky-500 inline-block pb-2">Places to Visit</h2>
               <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                 <div *ngFor="let place of destination.places; let i = index"
                      class="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 animate-heading"
