        ...
        <div class="relative h-[65vh] min-h-[500px] w-full flex items-center justify-center overflow-hidden">
          ...
          <div class="relative z-20 text-center px-4 animate-fade-slide">
            ...
            <div class="mt-10 flex flex-wrap justify-center gap-4">
               <button (click)="openBooking(placeData.name)" 
                       class="group relative px-10 py-4 bg-sky-500 text-white rounded-2xl font-black uppercase tracking-[0.2em] hover:bg-sky-600 transition-all shadow-[0_20px_50px_rgba(14,165,233,0.3)] hover:shadow-[0_20px_50px_rgba(14,165,233,0.5)] active:scale-95 flex items-center gap-3 overflow-hidden">
                 <!-- Gloss effect -->
           ...
           <div class="bg-white rounded-3xl p-10 shadow-2xl border border-slate-100">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                 <div>
                    ...
                    <button (click)="openBooking(placeData.name)" class="w-full md:w-auto px-8 py-4 bg-slate-900 text-white rounded-xl font-black uppercase tracking-widest hover:bg-sky-500 transition-all shadow-lg flex items-center justify-center gap-3 active:scale-95">
